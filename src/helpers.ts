export const saveLocalStorage = (docNumbers: any) => {
...
export const priceToWordsHelper = (priceNumber: number): string => {
  ...
  if (tenThousandNumber >= 10000) {
    ...
    if (
      ...
      priceNumber = priceNumber - tenThousandNumber + (priceNumber % 10000);
    }
  }
  ...
  if (thousandNumber) {
    ...
    if (thousandNumberFirstPosition === 1) {
      if (tenThousandNumberWord) {
        console.log(thousandNumberFirstPosition);
        thousandNumberWord = words[thousandNumberFirstPosition] + words[1000];
      } else {
        thousandNumberWord = words[1000];
      }
    } else {
      thousandNumberWord = words[thousandNumberFirstPosition] + words[1001];
    }
